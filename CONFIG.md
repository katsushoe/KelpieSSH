...
| `Server:Port` | no | `45432` | Local HTTP port used by the MCP server when command options are loaded. Usually configured in `kelpiemcp.json`. |
...
| `Server:Port` | no | `45432` | Local HTTP port for the MCP endpoint. |
