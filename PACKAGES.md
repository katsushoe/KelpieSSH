...
| `kelpiemcp` | `src/KelpieServerCommand/KelpieServerCommand.csproj` | `0.3.13.0` | MCP server control and human-only remote policy/helper administration CLI. | `KelpieHome/bin/kelpiemcp.exe` |
